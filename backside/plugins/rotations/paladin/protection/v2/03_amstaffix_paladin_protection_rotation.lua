...
local ok, err = pcall(function()
    ...
    ---@class PaladinProtectionV2Config
    local Config = {
    ...
    ---@return PaladinProtectionV2Config
    ...
    ---@param object PaladinProtectionV2Config another config
    ...
    ---@class PaladinProtectionV2SealSettings
    ...
    ---@return PaladinProtectionV2SealSettings
    ...
    ---@return table<number,PaladinProtectionV2SealSettings> seal settings' config index to PaladinProtectionV2SealSettings
    ...
    ---Determine state
    ---@param cr AmstLibCombatRotation
    ---@param cfg PaladinProtectionV2Config config
    ---@return void
